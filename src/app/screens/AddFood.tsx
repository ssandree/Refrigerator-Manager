...
export default function AddFood() {
  ...
  const getInitialData = () => {
    ...
    expiryDate.setDate(today.getDate() + 30); // 기본값: 30일 후
    ...
    return {
      ...
      storageLocation: StorageLocation.ROOM_TEMP, // 기타는 상온
      alertBeforeDays: 3,
    };
  };

  const [formData, setFormData] = useState<Partial<Ingredient>>(getInitialData());
  ...
  const handleSave = () => {
    ...
    const newIngredient: Ingredient = {
      ...
      imageUrl: "../assets/images/tomato.jpg", // 기본 이미지
      name: formData.name!,
    ...
    // 여기서 실제로 데이터를 저장하는 로직을 구현
    console.log("새로운 재료 등록:", newIngredient);
    ...
    <>
      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>재료 등록</Text>
        ...
        <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
          ...
          <TouchableOpacity style={styles.saveButton} onPress={handleSave}>
            <Text style={styles.saveButtonText}>재료 등록</Text>
          </TouchableOpacity>
        </ScrollView>
      </View>
    </SafeAreaView>
